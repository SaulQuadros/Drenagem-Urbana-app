...
# Gerar documento Word formatado com a formatação ajustada
if st.button('📄 Gerar Relatório em Word'):
    ...
    # Título do relatório
    titulo = doc.add_heading('Relatório de Parâmetros da Bacia Hidrográfica de Contribuição', 0)
    titulo.alignment = WD_PARAGRAPH_ALIGNMENT.CENTER
    titulo.runs[0].font.size = Pt(15)
    ...
    # Adicionando os resultados com a formatação ajustada
    for nome, valor, interpretacao in resultados:
        # Parágrafo com o nome do parâmetro e valor
